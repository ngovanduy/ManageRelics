...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="charts.jsp"><em class="fa fa-bar-chart">&nbsp;</em> Charts</a></li>
			<li><a href="elements.jsp"><em class="fa fa-toggle-off">&nbsp;</em> UI Elements</a></li>
			<li class="active"><a href="panels.jsp"><em class="fa fa-clone">&nbsp;</em> Alerts &amp; Panels</a></li>
